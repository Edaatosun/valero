...
export function CupSelection() {
  ...
  const setSelectedMl = async (item) => {
    if (item) {
      ...
      try {
        const selectedCup = new Cup(userId, item.uri, item.ml, item.name);
  ...
  const [cupOptions, setCupOptions] = useState([
    { id: 1, name: "Su(Varsayılan)", ml: 100,  uri: 'https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F1.png?alt=media&token=12c38275-dc31-4640-a752-2cb157bc5d9c' },
    { id: 2, name: "Su(Varsayılan)", ml: 125, uri: 'https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F6.png?alt=media&token=03dbd746-864a-4f86-9624-342c56855a83' },
    { id: 3, name: "Su(Varsayılan)", ml: 150, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F2.png?alt=media&token=d55dcb01-a6af-4473-b4bb-f98512236cfa" },
    { id: 4, name: "Su(Varsayılan)", ml: 200, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F3.png?alt=media&token=3102e574-0235-44c4-8232-ed91354b21f4" },
    { id: 5, name: "Su(Varsayılan)", ml: 250, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F8.png?alt=media&token=d419fd90-ff62-4ebb-a679-61791d370641" },
    { id: 6, name: "Su(Varsayılan)", ml: 300, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F9.png?alt=media&token=939329a7-eaa8-4504-8b23-6fbdce4fd1eb" },
    { id: 7, name: "Su(Varsayılan)", ml: 400, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F5.png?alt=media&token=e1013965-9d6b-4588-a99e-094bcfbc9ba0" },
    { id: 8, name: "Su(Varsayılan)", ml: 500, uri: "https://firebasestorage.googleapis.com/v0/b/waterapp-cd21d.firebasestorage.app/o/waterCupImage%2F10.png?alt=media&token=fb2f0d7c-be8a-4273-a52c-df172e933d2f" },
