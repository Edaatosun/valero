...
export default function Prize() {
  ...
  <Text className="mt-6 text-base text-center leading-6 font-semibold text-gray-800">
    Tebrikler! Bugün su hedefini tamamladın!{"\n"}
    Sağlığın için harika bir adım attın!{"\n"}
    Hedeflerini tamamlamaya devam et.{"\n"}
    🎁 Yeni ödüller seni bekliyor!
  </Text>
</View>
            ...
            <View className="justify-end flex-1 mb-5">
                <View className="flex-row justify-between items-center">
                    <TouchableOpacity
                        ...
                        className={`bg-gray-100 p-5 items-center rounded-3xl mr-10  mb-8 px-14 ${isBackButtonDisabled ? 'opacity-50' : ''}`}>
                        <Text className="text-blue-400">Geri</Text>
                    </TouchableOpacity>

                    <TouchableOpacity className="bg-blue-400 w-50 p-5 mb-8 items-center rounded-3xl">
