...
export default function Profile() {
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      >
        <View className="flex-1 justify-center items-center bg-black bg-opacity-50">
          <View className="bg-white p-6 rounded-lg w-80 justify-center">
            <Text className="text-lg font-bold mb-4">Yeni Şifre Girin</Text>
            <TextInput
              className="border-2 border-blue-500 bg-white items-center justify-center rounded-lg px-4 py-3 w-full"
